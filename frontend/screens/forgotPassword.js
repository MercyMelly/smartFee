...
const handleSendOtp = async () => {
  ...
  try {
      ...
      const res = await axios.post('https://300b-2c0f-fe38-2405-29ac-4d1a-39c4-f7e-d4b8.ngrok-free.app/api/password/send-otp', { email });
...
const handleVerifyOtp = async () => {
  ...
  try {
      ...
      const res = await axios.post('https://300b-2c0f-fe38-2405-29ac-4d1a-39c4-f7e-d4b8.ngrok-free.app/api/password/verify-otp', { email, otp });
...
const handleResetPassword = async () => {
  ...
  try {
      ...
      const res = await axios.post('https://300b-2c0f-fe38-2405-29ac-4d1a-39c4-f7e-d4b8.ngrok-free.app/api/password/reset-password', {
